...
abstract class $EmbeddedChatRoomTextMessageCopyWith<$Res> {
  ...
  @useResult
  $Res call({String profileRef, String text, ChatRoomMessageType type});
}
...
class _$EmbeddedChatRoomTextMessageImpl extends _EmbeddedChatRoomTextMessage {
  ...
  @override
  String toString() {
    return 'EmbeddedChatRoomTextMessage(profileRef: $profileRef, text: $text, type: $type)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, profileRef, text, type);
