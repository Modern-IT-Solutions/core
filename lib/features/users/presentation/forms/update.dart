...
// /// [UpdateUserForm] is a form to create a new user
// class UpdateUserForm extends StatefulWidget {
//   final VoidCallback? onCancel;
//   final Null Function(UserModel user)? onUpdated;
//   final UserModel user;
//   const UpdateUserForm({Key? key, this.onUpdated, this.onCancel, required this.user}) : super(key: key);
...
//     _phoneController = TextEditingController(text: widget.user.phoneNumber?.substring(4));
...
//         _loading = true;
//       });
//       var createRequest = UserUpdateRequest(
...
//       );
//       try {
//         var userRecord = await UserRepository.instance.update(widget.user.uid, createRequest);
//         // TODO: Update user in the list
//         // widget.onUpdated?.call(userRecord);
//       }
